...
def help_msg(update, context):
    update.message.reply_text("Send any instagram users username or  profile url to get their DP")
...
def username(update, context):
    ...
    if not re.compile(mediaregpat).search(query):
        ...
        try:
            ...
            update.message.reply_text("Thank you for using this bot.Consider share @instadpinfobot")
